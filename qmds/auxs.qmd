...
$$
\hat{ATT} = E[Y_1(1)|D=1] - E[Y_0(0)|D=1] = 41.05
$$
...
$$
\hat{ATT} = E[Y_1(1)|D=1] - E[Y_0(1)|D=0] = -119.1
$$
$$
Y_D(T)
$$
...
<!-- H_1: \text{Al menos una de las betas es distinta de cero} -->
<!-- \end{array} -->
<!-- $$ -->

<!-- $$ -->
<!-- \text{subclas\_estimator} = \text{SDO}_{\text{east}} \left( \frac{n_{\text{east}}}{n_{\text{total}}} \right) + \text{SDO}_{\text{north}} \left( \frac{n_{\text{north}}}{n_{\text{total}}} \right) + \text{SDO}_{\text{west}} \left( \frac{n_{\text{west}}}{n_{\text{total}}} \right) -->
<!-- $$ -->

<!-- $$ -->
<!-- \widehat{\tau}_{\text{subclass}} = \sum_{g \in \mathcal{G}} \text{SDO}_g \left( \frac{n_g}{n_{\text{total}}} \right) -->
<!-- $$ -->