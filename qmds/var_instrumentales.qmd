...
## `r emo::ji("skull")` ¡¡¡CUIDADO!!! `r emo::ji("skull")`

`r emo::ji("eye")` Versión generada con NotebookLM a partir de los capítulos sobre el tema de @cunningham2021causal y @huntington2021effect. Consumir bajo su propio riesgo ya que la información **no está chequeada**. `r emo::ji("eye")`
:::
